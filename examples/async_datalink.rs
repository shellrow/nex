...
fn main() -> std::io::Result<()> {
    ...
    let AsyncChannel::Ethernet(mut tx, mut rx) = async_channel(&interface, Config::default())?
    else {
        unreachable!();
    };
    ...
    futures::executor::block_on(async {
        ...
        // Receive a packet via StreamExt::next.
        ...
        loop {
            match rx.next().await {
                ...
                Some(Err(e)) => eprintln!("Failed to receive: {}", e),
                None => {
